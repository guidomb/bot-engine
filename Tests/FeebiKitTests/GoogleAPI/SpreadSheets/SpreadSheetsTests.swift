...
class SpreadSheetsTest: XCTestCase {
    ...
    func testSpreadSheetValuesBatchGetResource() {
        ...
        XCTAssertEqual(resource.urlPath, "spreadsheets/somespreadsheetid123456/values:batchGet?ranges='Universales-1-18'!B2%3AB2&ranges='Universales-1-18'!B3%3AB3&ranges='Universales-1-18'!B6%3AI9&majorDimension=rows&valueRenderOption=FORMATTED_VALUE&dateTimeRenderOption=SERIAL_NUMBER")
    }
