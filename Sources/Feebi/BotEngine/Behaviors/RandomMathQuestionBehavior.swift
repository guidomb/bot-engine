...
struct RandomMathQuestionBehavior: BehaviorProtocol {

    typealias _Behavior = Behavior<State, NoEffect>
    ...
    func createSchedulable(services: BotEngine.Services) -> BehaviorSchedulableJobs<NoBehaviorJobExecutor>? {
        return .none
    }

    func createEffectPerformer(services: BotEngine.Services) -> NoEffectPerformer {
